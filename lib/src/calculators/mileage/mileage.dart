...
const _mileageInputSchema = CalculatorInputSchema(
  fields: [
    CalculatorInputField(key: 'km', label: 'distance (km)', defaultValue: '500'),
    CalculatorInputField(key: 'l', label: 'fuel used (L)', defaultValue: '40'),
    CalculatorInputField(key: 'price', label: 'fuel price (/L)', defaultValue: '1.50'),
  ],
);
    ...
    () async {
      ...
      return CalculatorResult(
        ...
        steps: [
          ...
          'Cost/km = $price × L/100km / 100 = '
              '${costPerKm.toStringAsFixed(4)}',
        ],
      );
    },
