...
const _clothingInputSchema = CalculatorInputSchema(
  fields: [CalculatorInputField(key: 'v', label: 'value', defaultValue: '38')],
  controls: [
    SegmentedToggleControl(key: 'kind', options: ['Top (US)', 'Dress (US)']),
    SegmentedToggleControl(key: 'sys', options: ['US', 'EU', 'UK']),
  ],
);
...
/// Registry entry for the clothingSize calculator.
