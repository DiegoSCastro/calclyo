...
enum BodyKind { sphere, cube, cylinder }
...
const _bodies3DInputSchema = CalculatorInputSchema(
  fields: [
    CalculatorInputField(key: 'r', label: 'radius (sphere / cylinder)', defaultValue: '3'),
    CalculatorInputField(key: 'h', label: 'height (cube / cylinder)', defaultValue: '5'),
  ],
  controls: [
