...
void main() {
  testWidgets(
    'SearchView shows recents, filters live, and shows empty state',
    (tester) async {
      ...
      final cubit = SearchCubit(
        recents: RecentsRepository(preferences: prefs),
      );
      ...
      expect(find.text('Tip amount and total from bill and percentage'),
          findsOneWidget);
